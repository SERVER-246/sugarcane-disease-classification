...
from config.settings import TEST_DIR, TRAIN_DIR, VAL_DIR
...
if missing_backbones:
    ...
    print("  ⚠️  Stage 1 will skip missing backbones")
else:
    print("  ✅ All backbone checkpoints found")

# Check 4: Output directories
print("\n[4/5] Checking output directories...")
from run_15coin_pipeline import (
    ENSEMBLE_DIR,
    STAGE1_DIR,
    STAGE2_DIR,
    STAGE3_DIR,
...
if recovery_status['recovery_available']:
    ...
    print("  ℹ️  No previous results - will start from Stage 1")
